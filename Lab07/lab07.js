...
<p><strong>Encoded Message:</strong> ${encod}</p>
<p><strong>Decoded Message:</strong> ${decod}</p>
<p><strong>Encoding and Decoding with Weak Keys:</strong></p>
<ul>
    <li>Encoded Message (Weak Keys): ${encod_sl}</li>
    <li>Decoded Message (Weak Keys): ${decod_sl}</li>
</ul>
<p><strong>Encoding and Decoding with Semi-Weak Keys:</strong></p>
<ul>
    <li>Encoded Message (Semi-Weak Keys): ${encod_polusl}</li>
    <li>Decoded Message (Semi-Weak Keys): ${decod_polusl}</li>
</ul>
`);
});
