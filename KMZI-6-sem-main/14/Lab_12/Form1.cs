    ...
    public partial class Form1 : Form
    {
        ...
        private void openFile_Click(object sender, EventArgs e)
        {
            ...
            if (openFileDialog.ShowDialog() == DialogResult.OK)
            {
                ...
                colorBitmap.Save("matrix.png", System.Drawing.Imaging.ImageFormat.Png);
            }
        }
        ...
        private void stegButton_Click(object sender, EventArgs e)
        {
            ...
            resultBitmap.Save("steganography1.png", System.Drawing.Imaging.ImageFormat.Png);


            Bitmap resultBitmap2 = new Bitmap(256, 256);

            for (int y = 0; y < 256; y++)
            {
                for (int x = 0; x < 256; x++)
                {
                    Color outputPixel = Color.FromArgb(binToDec(redArr[x, y]), binToDec(greenArr[x, y]), binToDec(blueArr[x, y]));
                    resultBitmap2.SetPixel(x, y, outputPixel);
                }
            }

       
            resultBitmap2.Save("steganography2.png", System.Drawing.Imaging.ImageFormat.Png);
